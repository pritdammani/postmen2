...
<head>
    ...
    <script src="{{ asset('public/js/pop_up.js') }}" defer></script>

    <!-- Fonts -->
    <link rel="dns-prefetch" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css?family=Raleway:300,400,600" rel="stylesheet" type="text/css">
<!-- download css of login-->

    <link rel="stylesheet" href="{{asset('css/icheck/skins/flat/blue.css')}}" >
    ...
    <link href="{{ asset('css/style-signup.css') }}" rel="stylesheet">
